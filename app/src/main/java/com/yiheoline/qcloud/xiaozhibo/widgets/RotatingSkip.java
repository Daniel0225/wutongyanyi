...
public class RotatingSkip extends View{
    ...
    public RotatingSkip(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //获取属性
        TypedArray typedArray = context.obtainStyledAttributes(R.styleable.RotatingSkip);
        mBgColor =typedArray.getColor(R.styleable.RotatingSkip_circleColor,0xff000000);
    ...
    private void drawCenterCircle(Canvas canvas){
        ...
        //绘制圆形
        mCicPaint.setColor(Color.TRANSPARENT);
